...
public class Test1 {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        //增、删、改
        String sql = "insert into wsl (id,name) values(96,'马尔扎哈')";
        state.executeUpdate(sql);

        //查
        String sql2 = "select * from wsl ";
        ...
        //增、删、改
        String sql4 = "insert into wsl (id,name,age) values (?,?,?)";
        ...
        //查
        String sql5 = "select * from wsl where id=?";
